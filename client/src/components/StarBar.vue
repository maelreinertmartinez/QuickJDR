    ...
    <div class="relative z-10 flex justify-between w-full px-4 items-center">
      ...
      <div class="flex items-center gap-1">
        <input
          ...
          :readonly="readonly"
          :readonly="readonly"
          @input="!readonly && !readonly && $emit('update:modelValue', Number($event.target.value))"
          class="bg-transparent text-right font-bold outline-none w-12 text-lg transition-colors transition-colors"
          :class="[
            [
            textColorClass,
